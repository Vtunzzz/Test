...
local function MakeDraggable(topbarobject, object)
    local function CustomPos(topbarobject, object)
        local Dragging = nil
        local DragInput = nil
        local DragMakeWindow = nil
        local MakeWindowPosition = nil

        local function UpdatePos(input)
            local Delta = input.Position - DragMakeWindow
            local pos =
                UDim2.new(
                MakeWindowPosition.X.Scale,
                MakeWindowPosition.X.Offset + Delta.X,
                MakeWindowPosition.Y.Scale,
                MakeWindowPosition.Y.Offset + Delta.Y
            )
        ...
        topbarobject.InputBegan:Connect(
            function(input)
                if
                 ...
                 then
                    Dragging = true
                    DragMakeWindow = input.Position
                    MakeWindowPosition = object.Position
    ...
    local function CustomSize(object)
        ...
        local function UpdateSize(input)
            local Delta = input.Position - DragMakeWindow
            local newWidth = MakeWindowSize.X.Offset + Delta.X
            local newHeight = MakeWindowSize.Y.Offset + Delta.Y
...
local function AutoUp(Scroll)
    Scroll.ChildAdded:Connect(
        function()
            UpSize(Scroll)
        end
    )
    Scroll.ChildRemoved:Connect(
        function()
            UpSize(Scroll)
        end
    )
...
local sitinklib = {}
function sitinklib:MakeNotify(NotifyConfig)
    ...
    NotifyConfig.Delay = NotifyConfig.Delay or 0.5
    ...
    spawn(
        function()
            ...
            function NotifyFunc:Close()
                ...
                TweenService:Create(
                    NotifyFrameReal,
                    TweenInfo.new(tonumber(NotifyConfig.Delay), Enum.EasingStyle.Back, Enum.EasingDirection.InOut),
                    {Position = UDim2.new(0, 330, 0, 0)}
                ):Play()
                task.wait(tonumber(NotifyConfig.Delay) / 1.2)
                NotifyFrame:Destroy()
            end
            NotifyClose.MouseButton1Click:Connect(
                function()
                    NotifyFunc:Close()
                end
            )
...
function sitinklib:MakeWindow(GuiConfig)
    ...
    GuiConfig.NamePlayers = GuiConfig.NamePlayers or tostring(game:GetService("Players").LocalPlayer.Name)
    GuiConfig.InfoDesc = GuiConfig.InfoDesc or "discord.gg/JURvkuHr28"
    ...
    GuiConfig.CloseCallBack = GuiConfig.CloseCallBack or function()
        end
    --// Gui
    ...
    Main.Position =
        UDim2.new(
        0,
        (SitinkGui.AbsoluteSize.X // 2 - Main.Size.X.Offset // 2),
        0,
        (SitinkGui.AbsoluteSize.Y // 2 - Main.Size.Y.Offset // 2)
    )

    sitinklib:MakeNotify({
        Title = "UI Library",
        Description = "Interface",
        Content = "Auto Visible UI, click the Icon to Show Interface",
        Time = 7
    })

    shit.Name = "shit"
    shit.Parent = SitinkGui
    ...
    Click23.Position = UDim2.new(0.120833337, 0, 0.0952890813, 0)
    Click23.Text = ""
    ...
    NamePlayer.Text = GuiConfig.NameInfo
    ...
    LogoPlayer.Image = GuiConfig.LogoInfo
    ...
    AnotherFrame.BackgroundColor3 = Color3.fromRGB(30, 30, 30)
    ...
    LogFrame.BackgroundColor3 = GuiConfig.InfoColor
    ...
    LogUnder.BackgroundColor3 = Color3.fromRGB(40, 40, 40)
    ...
    LogTitle.Text = GuiConfig.NamePlayers
    ...
    LogDescription.Text = GuiConfig.InfoDesc
    ...
    LogoInfo.Image = GuiConfig.LogoPlayers
    ...
    UIStroke5.Color = Color3.fromRGB(40, 40, 40)
    ...
    AnotherButton.MouseButton1Click:Connect(
        function()
            TweenService:Create(
                LogFrame,
                TweenInfo.new(0.3, Enum.EasingStyle.Quad, Enum.EasingDirection.InOut),
    ...
    local Tabs = {}
    local CountTab = 0
    function Tabs:MakeTab(ConfigsTab)
        ConfigsTab = ConfigsTab or {}
        ConfigsTab.Name = ConfigsTab.Name or ""
        ...
        function Sections:MakeSection(SectionConfig)
            ...
            if SectionDescription.Text == "" then
                ...
                SectionDescription:GetPropertyChangedSignal("AbsoluteSize"):Connect(
                    function()
                        SectionDescription.TextWrapped = false
                        SectionDescription.Size =
                            UDim2.new(
                            1,
                            -70,
                            0,
                            11 + (11 * (SectionDescription.TextBounds.X // SectionDescription.AbsoluteSize.X))
                        )
            ...
            local Items = {}
            local CountItem = 0
            function Items:Section(SeperatorName)
                ...
                Seperator:GetPropertyChangedSignal("AbsoluteSize"):Connect(
                    function()
                        Seperator.TextWrapped = false
                        Seperator.Size =
                            UDim2.new(1, -8, 0, 16 + (11 * (Seperator.TextBounds.X // Seperator.AbsoluteSize.X)))
            ...
            function Items:MakeParagraph(ParagraphConfig)
                ...
                ParagraphContent.Size = UDim2.new(1, -10, 0, 11)
                    ...
                    ParagraphContent:GetPropertyChangedSignal("AbsoluteSize"):Connect(
                        function()
                            ...
                            ParagraphContent.Size =
                                ...
                                -110,
                                0,
                                11 + (11 * (ParagraphContent.TextBounds.X // ParagraphContent.AbsoluteSize.X))
                            )
            ...
            function Items:MakeButton(ButtonConfig)
                ...
                ButtonContent.Text = ButtonConfig.Description
                ...
                if ButtonContent.Text == "" then
                    ...
                    ButtonContent:GetPropertyChangedSignal("AbsoluteSize"):Connect(
                        function()
                            ...
                            ButtonContent.Size =
                                ...
                                -150,
                                0,
                                11 + (11 * (ButtonContent.TextBounds.X // ButtonContent.AbsoluteSize.X))
                            )
                    ...
                    ButtonContent.TextWrapped = false
                    ButtonContent.Size =
                        UDim2.new(1, -150, 0, 11 + (11 * (ButtonContent.TextBounds.X // ButtonContent.AbsoluteSize.X)))
                    Button.Size = UDim2.new(1, -8, 0, ButtonContent.AbsoluteSize.Y + 33)
                    ButtonContent.TextWrapped = true
                    UpSize(ScrollLayer1)
                end
            ...
            function Items:MakeTextBox(TextInputConfig)
                local TextInputConfig = TextInputConfig or {}
                TextInputConfig.Name = TextInputConfig.Name or "Title"
                TextInputConfig.Description = TextInputConfig.Description or ""
                TextInputConfig.DefaultText = TextInputConfig.DefaultText or "Enter your text here..."
                TextInputConfig.DeteteTextOnFocus = TextInputConfig.DeteteTextOnFocus or true
                TextInputConfig.Default = TextInputConfig.Default or ""
                TextInputConfig.Callback = TextInputConfig.Callback or function()
                    end
                ...
                TextInputContent.Text = TextInputConfig.Description
                ...
                if TextInputContent.Text == "" then
                    ...
                    TextInputContent:GetPropertyChangedSignal("AbsoluteSize"):Connect(
                        function()
                            TextInputContent.TextWrapped = false
                            TextInputContent.Size =
                                UDim2.new(
                                1,
                                -150,
                                0,
                                11 + (11 * (TextInputContent.TextBounds.X // TextInputContent.AbsoluteSize.X))
                            )
                ...
                TextInputTitle.Text = TextInputConfig.Name
                ...
                InputBox.PlaceholderText = TextInputConfig.DefaultText
                ...
                InputBox.ClearTextOnFocus = TextInputConfig.DeteteTextOnFocus
            ...
            function Items:MakeToggle(ToggleConfig)
                local ToggleConfig = ToggleConfig or {}
                ToggleConfig.Name = ToggleConfig.Name or "Title"
                ...
                ToggleContent.Text = ToggleConfig.Description
                ...
                if ToggleContent.Text == "" then
                    ...
                    ToggleContent:GetPropertyChangedSignal("AbsoluteSize"):Connect(
                        function()
                            ...
                            ToggleContent.Size =
                                ...
                                -70,
                                0,
                                11 + (11 * (ToggleContent.TextBounds.X // ToggleContent.AbsoluteSize.X))
                            )
                    ...
                    ToggleContent.TextWrapped = false
                    ToggleContent.Size =
                        UDim2.new(1, -70, 0, 11 + (11 * (ToggleContent.TextBounds.X // ToggleContent.AbsoluteSize.X)))
                    Toggle.Size = UDim2.new(1, -8, 0, ToggleContent.AbsoluteSize.Y + 33)
                    ToggleContent.TextWrapped = true
                end
            ...
            function Items:MakeSlider(SliderConfig)
                local SliderConfig = SliderConfig or {}
                SliderConfig.Name = SliderConfig.Name or "Slider"
                SliderConfig.Description = SliderConfig.Description or "Content"
                ...
                SliderContent.Text = SliderConfig.Description
                ...
                if SliderContent.Text == "" then
                    ...
                    SliderContent:GetPropertyChangedSignal("AbsoluteSize"):Connect(
                        function()
                            ...
                            SliderContent.Size =
                                ...
                                -150,
                                0,
                                11 + (11 * (SliderContent.TextBounds.X // SliderContent.AbsoluteSize.X))
                            )
                    ...
                    SliderContent.TextWrapped = false
                    SliderContent.Size =
                        UDim2.new(1, -150, 0, 11 + (11 * (SliderContent.TextBounds.X // SliderContent.AbsoluteSize.X)))
                    Slider.Size = UDim2.new(1, -8, 0, SliderContent.AbsoluteSize.Y + 33)
                    SliderContent.TextWrapped = true
                end
                ...
                SliderFrDrag.InputBegan:Connect(
                    function(Input)
                        if Input.UserInputType == Enum.UserInputType.MouseButton1 then
                            Dragging = true
                        end
                ...
                SliderFrDrag.InputEnded:Connect(
                    function(Input)
                        if Input.UserInputType == Enum.UserInputType.MouseButton1 then
                            Dragging = false
                        end
            ...
            function Items:MakeDropdown(DropdownConfig)
                local DropdownConfig = DropdownConfig or {}
				DropdownConfig.Name = DropdownConfig.Name or "Title"
				DropdownConfig.Options = DropdownConfig.Options or {}
				DropdownConfig.Default = DropdownConfig.Default or ""
                DropdownConfig.PlaceHolderText = DropdownConfig.PlaceHolderText or "Select Options"
                ...
                function DropdownFunc:Set(Value)
                    DropdownConfig.Default = Value or DropdownConfig.Default
                    for _, Drop in ScrollUnder:GetChildren() do
                        if Drop.Name ~= "UIListLayout" then
                            if Drop.Name == "Option" then
                                if typeof(DropdownConfig.Default) == "string" and DropdownConfig.Default ~= Drop.OptionText.Text then
                                    Drop.ChoosingFrame.AnchorPoint = Vector2.new(0, 0)
                                    Drop.ChoosingFrame.Position = UDim2.new(0, 5, 1, -0)
                                    TweenService:Create(
                                        Drop,
                                        TweenInfo.new(0.3, Enum.EasingStyle.Quad, Enum.EasingDirection.InOut),
                                ...
                                elseif typeof(DropdownConfig.Default) == "string" and DropdownConfig.Default == Drop.OptionText.Text then
                                    Drop.ChoosingFrame.AnchorPoint = Vector2.new(0, 0)
                                    ...
                                    TweenService:Create(
                                        Drop.ChoosingFrame,
                                        TweenInfo.new(0.3, Enum.EasingStyle.Quad, Enum.EasingDirection.InOut),
                                        {Size = UDim2.new(0, 2, 0, 20), Transparency = 0}
                                    ):Play()
                                    TweenService:Create(
                                        Drop.ChoosingFrame.UIStroke,
                                        TweenInfo.new(0.3, Enum.EasingStyle.Quad, Enum.EasingDirection.InOut),
                ...
                function DropdownFunc:Add(OptionName)
                    ...
                    ChoosingFrame3.AnchorPoint = Vector2.new(0 ,0)
                    ...
                    OptionButton.MouseButton1Click:Connect(function()
                        DropdownConfig.Default = OptionText.Text
                        DropdownBox.Text = OptionText.Text
                        DropdownConfig.Callback(OptionText.Text)
                        for i, v in pairs(ScrollUnder:GetChildren()) do
                            if v.Name == "Option" then
                                for r, b in pairs(v:GetChildren()) do
                                    if b.Name == "OptionText" then
                        ...
                        for i, v in pairs(ScrollUnder:GetChildren()) do
                            if v.Name == "Option" then
                                for r, b in pairs(v:GetChildren()) do
                                    if b.Name == "ChoosingFrame" then
                                        TweenService:Create(b,TweenInfo.new(0.2, Enum.EasingStyle.Quad, Enum.EasingDirection.Out),{Size = UDim2.new(0, -2, 0, 0)}):Play()
                                    end
                                end
                            end
                        end
                        DropdownFunc:Set(OptionText.Text)
                        OptionText.TextColor3 = Color3.new(255, 255, 255)
                        ChoosingFrame3.Transparency = 0
                        Option1.BackgroundColor3 = Color3.fromRGB(70, 70, 70)
                        TweenService:Create(ChoosingFrame3,TweenInfo.new(0.2, Enum.EasingStyle.Quad, Enum.EasingDirection.Out),{Size = UDim2.new(0, 2, 0, 0)}):Play()
                    end)
                ...
                function DropdownFunc:Refresh(RefreshList, Selecting)
					...
					DropdownConfig.Options = RefreshList
                ...
                if DropdownConfig.Default == "" or DropdownConfig.Default == nil then
                    DropdownBox.Text = ""
                else
                    DropdownBox.Text = tostring(DropdownConfig.Default)
                end
